...
An open-source, ultra-fast, minimalist **Terminal YouTube Music Player** built for Linux CLI power users. Featuring an **animated real-time beat bars visualizer**, continuous **Smart Radio autoplay**, synchronized LRC lyrics, time seeking, and complete queue management—all in a sleek monochrome TUI.

---

## ⚡ Global 1-Line Installation (Auto-Cleaned)

Install Trainy TUI globally with auto-cleanup (cloned setup files are automatically removed after installation):
...
├────────────────────────────────────────────────────────────────────────────┤
│ Search songs, artists, albums... (Press / to focus)                        │
├─────────────────────────────────────────────┬──────────────────────────────┤
...
1. **Clone the Repository:**
   ```bash
   git clone https://github.com/fiozxr/trainy-tui.git
   cd trainy-tui
   ```
